...
public class ProductInfoPage {
    ...
    private By productMetaData = By.cssSelector("div#content ");
    private By productPriceData = By.cssSelector(null);
    private By qty = By.id(null);
    private By addToCartBtn = By.id("");
